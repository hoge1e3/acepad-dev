import {renderModifierState,modifiers} from '@acepad/keypad';
const {getModifier,setModifier}=modifiers;
...
export function checkEnterEditMode(editor){
  if(process.env.shiftarrow)return;
...
export function quitEdit(editor){
    unsetSel(editor);
