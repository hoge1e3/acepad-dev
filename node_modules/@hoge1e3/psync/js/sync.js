...
import { data2zip, data2dir, dir2data, validate, get as sget } from "./store-file.js";
import { getDelta, getDeltaDelta } from "./delta.js";
export { getDelta, getDeltaDelta } from "./delta.js";
import { assert } from "chai";
import { instance, find, conflictFile } from "./dot-sync.js";
import { zip } from "./zip.js";
export { head } from "./store.js";
export { setFS } from "./store-file.js";
export async function init(dir, data = {}) {
...
export function getBranchName(dir) {
...
export async function downloadZip(dir, id) {
...
export async function chain(id) {
    return await store.$get({ chain: id });
}
...
function sameIgnoreCR(a, b) {
    a = a.replace(/\r/g, "");
    b = b.replace(/\r/g, "");
    return a === b;
}
export class ConfilictError extends Error {
    constructor(message, conflictFiles, __id__) {
        super(message);
...
async function getRemoteLatestCheckout(workDirStat) {
