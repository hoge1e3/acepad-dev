...
export async function main() {
    ...
    w.print(t.div({ id: "test-me" }, t.button({ id: "b1" }, "Button1"), t.button({ id: "b2" }, "Button2"), t.button({ onclick: rmEvent }, "Remove event b1"), t.button({ onclick: overEvent }, "Overwrite event b1<-b2")));
