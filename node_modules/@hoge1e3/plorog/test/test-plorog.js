import * as plorog from "@hoge1e3/plorog";
import * as assert from "assert";
import {initDB} from "./db.js";
import {solve,solveExpr,showAns} from "../solver.js";
import {Variable,OutputChannel,MatchContext} from "../variable.js";
export async function main(){
    ...
    //dprint(db);
    for(let res of solveExpr(db,pred, new MatchContext())){
        showAns(res);
    }
    console.log("no");
}
