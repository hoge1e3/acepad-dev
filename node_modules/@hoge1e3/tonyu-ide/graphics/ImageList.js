import PP from "./PatternParser.js";
import Assets from "../fs/Assets.js";
//import assert from "assert";
//import urlTrailer from "../fs/urlTrailer.js";
var cache={};
...
IL=function (resImgs, onLoad,options) {
    ...
    // onLoad: (
    //    res:[{image:Image, x:0,y:0, width:this.width, height:this.height}] &
    //         
    // )=>void
    // options: {prj} | {baseDir} 
  ...
  if (!options) options={};
    ...
    resImgs.forEach(function (resImg,i) {
        ...
        im.attr("src",url);//urlTrailer.put(url));
        function proc() {
            var pw,ph;
...
IL.parse1=function (resImg, imgDOM, options) {
    ...
    return res;//assert.is(res,Array);
};
window.ImageList=IL;
export default IL;