...
import EventHandler from "./EventHandler.js";
	...
	const init=()=>new Promise(succ=>{
		...
		function initInstance() {
			...
			if (senderOrigin && senderID) {
				receiver=new MesgReceiver(senderOrigin, senderID);
			}
		}
	});
    ...
    const createSender=params=>new MesgSender(params);
    export default { init, receiver, createSender };
