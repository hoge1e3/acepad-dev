import * as FS from "./SFile.js";
import reqConfModule from "reqConf";

var js=FS.get("js");
export function genShim(req,res) {
    var reqConf=reqConfModule.conf;
...
export function concat(req,res) {
...
function uglify(srcF, dstF) {
    import("uglify-js").then(({default: UglifyJS}) => {
