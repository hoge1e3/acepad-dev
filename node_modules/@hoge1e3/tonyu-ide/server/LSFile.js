import * as SFile from "./SFile.js";

var fsHome=SFile.get("fs");
var DINFO=".dirinfo";
export function File2LS(req, resp){
...
export function LS2File(req, res){
...
export function getDirInfo(req, resp){
...
export function File2LSSync(req, resp){
...
export function LS2FileSync(req, res){
    var base=req.body.base;
