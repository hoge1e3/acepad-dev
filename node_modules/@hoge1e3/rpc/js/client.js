...
import { isFail, isReadyResponse, isSuccess, readyRequest } from "./types.js";
...
export class Client {
    ...
    run(path_1) {
        return __awaiter(this, arguments, void 0, function* (path, params = {}, transfer = []) {
            const t = this;
