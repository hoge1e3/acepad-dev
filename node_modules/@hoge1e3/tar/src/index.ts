...
*/
export async function tarEncode(files: File[], gzip?: boolean): Promise<Uint8Array> {
...
export async function tarDecode(tar: Uint8Array<ArrayBuffer>, gzip?: boolean): Promise<File[]> {
    const TAR_BLOCK_SIZE = 512;
