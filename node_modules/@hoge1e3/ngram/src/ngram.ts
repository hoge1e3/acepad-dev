...
export class Index{
    abstract add(doc:Document, offset:number);
}
//=DocumentIndex|LetterIndex;
...
export class LetterIndex extends Index{
...
export class DocumentIndex{
    map=new DefaultMap<Document , number[]>(),
    count: number=0,
    constructor (
