...
/*
eof is needed when
'something' is indexed and a file is ended with 'some'
s-o-m-e is LetterIndex, it sholud be indexed by 
s-o-m-e-EOF
...
export class LetterIndex {
    ...
    add(doc:Document, offset:number){
        ...
        this.count++;
        if (offset+1>=doc.content.length+1) {
            return;
        }
