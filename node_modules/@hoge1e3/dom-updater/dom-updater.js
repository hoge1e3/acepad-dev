...
export function nodeRef(node) {
    ...
    res[sym_noderef] = node;
    return res;
}
export function unnodeRef(node) {
    const ref = node[sym_noderef];
    return ref !== null && ref !== void 0 ? ref : node;
}
export function update(_dst, src, opt = {}) {
