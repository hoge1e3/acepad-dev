...
export var sh=(function () {   
    ...
    /*function url2path(url){
        let e=root.urls.get({url});
        return e && e.path;
    }*/
    //const url2path=FS.os.urlToPath;
    ...
    Shell.addHist=function (cmd) {
        return this._hist.add(this.cwd,cmd);  
    };
    ...
    Shell.prompt=function () {
        ...
        //sh.echo(`[${this.cwd.relPath(home)}]$ `,{n:1});
    };
