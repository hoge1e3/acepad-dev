import { asLocalRef, asBranchName, asHash, asFilePath } from "../src/types.js";
import { RecursiveGitIgnore, Repo } from "../src/git.js";
import { Sync } from "../src/sync.js";
import { clone, commit, sync } from "../src/cmd.js";
...
import fs from "fs";
import { FileBasedObjectStore } from "../src/objects.js";
...
export async function testHash() {
    ...
    async function newLineType(path, hash) {
