...
export declare class Repo {
    ...
    getFMTStorage(): Promise<FMTStorage | undefined>;
    setHashToFMT(path: FilePath, hash: Hash): Promise<void>;
    getHashFromFMT(path: FilePath): Promise<Hash | null>;
    ...
    isSubRepo(dir: FilePath): Promise<boolean>;
    inSubRepo(_path: FilePath): Promise<boolean>;
    applyDiff(diffs: TreeDiffEntry[]): Promise<void>;
    hasSymlinkInPath(targetPath: FilePath): Promise<boolean>;
    updateIndexFromWorkingDir(indexPath: FilePath): Promise<Index>;
    writeTreeFromIndex(index: Index): Promise<Hash>;
    getBranches(): Promise<BranchName[]>;
...
export declare class IgnoreChecker {
    ...
    baseig: Ignore;
    static init(repo: Repo): Promise<IgnoreChecker>;
    private constructor();
    get(dir: FilePath): Promise<RecursiveGitIgnore>;
    ignores(file: FilePath): Promise<boolean>;
}
type IgnoreStack = {
    dir: FilePath;
    ig: Ignore;
...
export declare class RecursiveGitIgnore {
    ...
    pushed(dir: FilePath): Promise<RecursiveGitIgnore>;
    poped(): Promise<RecursiveGitIgnore>;
}
export declare function isUtf8Text(buffer: Uint8Array<ArrayBufferLike>): string | null;
export declare function stripCR(content: Uint8Array<ArrayBufferLike>): Uint8Array<ArrayBufferLike>;
