declare const sym_pts: unique symbol;
export type PHPTimestamp = number & {
    [sym_pts]: 1;
};
export declare function asPHPTimestamp(t: number): PHPTimestamp;
...
export type IgnoreState = "none" | /* do not ignore */ "max_mtime" | /* use maxMtime */ "all";
...
export type ConflictResolutionPolicy = "saveHashedRemote" | /*"saveHashedLocal" |*/ "ignoreLocal" | "ignoreRemote" | "newer";
