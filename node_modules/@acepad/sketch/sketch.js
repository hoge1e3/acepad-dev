...
export function main(){
    ...
    function ontouchstart(e){
        ...
        if(e.touches.length>1){
            ...
            pinch0.pivot=conv(pinch0.m,transform);
            e.stopPropagation();
            e.preventDefault();
            return ;
        }
    ...
    function ontouchmove(e){
        ...
        if(e.touches.length>1&&pinch0){
            ...
            const s1=s0*pinch1.d/pinch0.d;
            const v0=pinch0.m;
            const v1=pinch1.m;
            const tl0=transform0.translate;
            /*
            x1=s0v0x+x0-s1v1x
            y1=s0v0y+y0-s1v1y
            */
            transform={
                scale: s1,
                translate: [
                    s0*v0[0]+tl0[0]-s1*v1[0],
                    s0*v0[1]+tl0[1]-s1*v1[1],
                ]
            };
            //transform.scale*=pinch2.d/pinch0.d;
            //const pivot2=conv(pinch2.m,transform);
            /*const m=sub(pivot2,pivot);
