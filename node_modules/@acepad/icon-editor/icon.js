...
hidden.width = ICON_SIZE; 
hidden.height = ICON_SIZE;
...
function viewToPixel({clientX, clientY}) {
  ...
  const s=pinchc.transform.scale;
...
function setCurrentColor(rgba){
   currentColor = rgbaToHex(rgba)||currentColor;
   return currentColor;
}
...
view.addEventListener('touchstart', e => {
  ...
  undo=()=>{
    setPixel(x,y,
    rgbaToHex(pickReserve)||currentColor);
    redraw();
  };
