...
export {meta,kill,
createProxy,createProxy as createProxy2,
createWorker,createInstance} 
...
function pNodeHeader(){
  ...
  await dev.loadFstab(${
    em(getDeviceManager().
    readFstab("/fstab.json",defaultFSTab))
  });
...
export async function createProxy0(main, rev={}){
