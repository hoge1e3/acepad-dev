...
const sym_follow=Symbol("sym_follow");
/*global globalThis*/
export var sh=(function () {   
    ...
    sh.enterCommand=function (s,a) {
        ...
        if(a)return this.evalCommand(args.concat(a));
    ...
    */
    ...
    sh.evalCommand=function (expr) {
        if (Array.isArray(expr)) {
            ...
            const r=f.apply(this, 
              expr.map(e=>this.evalCommand(e)));
            if(expr[sym_follow]){
              return Promise.resolve(r).
                then(()=>this.enterCommand(
                  expr[sym_follow]));
            }
            return r;
        } else {
