...
export function add(session, range, options) {
  ...
  highlight1.update = (html, markerLayer, session, config) => {
    ...
    //console.log(markerElement,html)
    /*markerElement.style.
      pointerEvent='auto';*/
  };
