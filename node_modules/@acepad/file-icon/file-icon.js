...
export async function splash(d){
  const s=document.querySelector(".splashscreen-container");
  
  s.style.display=d?"flex":"none";
  await sleep(10);
}
// 初期表示
//renderDirectory(currentPath);
