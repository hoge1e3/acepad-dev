...
<div id="keypad" class="keypad">
    ...
    <div class="row justify">
        <button class="autorepeat" data-keycode="37" data-key="ArrowLeft">←</button>
        <button class="autorepeat" data-keycode="38" data-key="ArrowUp">↑</button>
        <button data-keycode="9" data-key="Tab">Tab</button>
        ...
        <button class="chr wide">^</button>
        <button class="chr wide">&</button>
        <button class="autorepeat" data-keycode="40" data-key="ArrowDown">↓</button>
        <button class="autorepeat" data-keycode="39" data-key="ArrowRight">→</button>
    ...
    <div class="row justify">
        ...
        data-keycode="8" data-key="Backspace">BS</button>
    </div>
    <div class="row justify">
        <button class="ctrl" 
         data-key="Control"
        ...
        <button data-keycode="27" data-key="Escape">Esc</button>
        <button class="chr wide">,</button>
        <button class="chr wide">:</button>
        <button data-text=" " 
        data-key=" "
        data-timing="up">SPC</button>
        <button class="chr wide">_</button>
        <button data-text=" " data-key=" " 
        class="wide">SPC</button>
        <button class="chr wide">.</button>
        <button data-keycode="13" data-key="Enter">Ent</button>
    </div>
    </div>
</div>
</div>
