...
let getMainEditor,getConfig,//from './states.js';
    detachCommands,attachCommands,parseCommands,// from './command.js';
...
export function extend(acepad) {
    ...
    detachCommands=acepad.detachCommands;
    attachCommands=acepad.attachCommands;
    parseCommands=acepad.parseCommands;
