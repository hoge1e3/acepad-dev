...
import {refInput as ri} from "@hoge1e3/ref-input";
  ...
  function refresh(r){
    ...
    w.print(t.div({id},
      ...
      ...r.map(s=>{
        ...
        const targetLines=def.value?s.lines.filter(l=>l.def>0):s.lines;
        const lines=highlight(f,q.value,targetLines);
    ...
    for (const {row} of lines) {
      ...
      result.push(t.div({
        onclick(){
          ...
          else sh.edit(f,{row:row+1,nomin:1,column:1});
        }
      },t.span({
        class: "filename"
