 ...
 // this.echo("c3");
  ...
  function reportDiagnostic(diagnostic: ts.Diagnostic) {
   /*const d={
        ...
        messageText:ms(diagnostic.messageText),
...
function toAnnotations(diagnostics: ts.Diagnostic[]):Annotation[] {
