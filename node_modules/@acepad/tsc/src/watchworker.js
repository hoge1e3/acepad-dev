...
export async function main(dir, ch) {
    await retry(() => process.chdir(dir));
    //this.echo(process.cwd());
    const configPath = ts.findConfigFile(
    /*searchPath*/ "./", ts.sys.fileExists, "tsconfig.json"); //q
    if (!configPath) {
    ...
    host.afterProgramCreate = program => {
        ...
        ch?.postMessage(toAnnotations(diags));
    };
    // `createWatchProgram` creates an initial program, watches files, and updates
    // the program over time.
    // this.echo("c3");
    ts.createWatchProgram(host);
    /*  function ms(messageText:ts.Diagnostic["messageText"]){
    ...
    function reportDiagnostic(diagnostic) {
        ...
        console.error("Error", diagnostic.code, ":", diagnostic.file, ts.flattenDiagnosticMessageText(diagnostic.messageText, formatHost.getNewLine()));
    }
}
/**
...
//# sourceMappingURL=watchworker.js.map