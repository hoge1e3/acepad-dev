...
let y = "23";
//_this is comment
export function main(dir, ch) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        yield retry(() => process.chdir(dir));
        ...
        host.afterProgramCreate = program => {
            ...
            ch === null || ch === void 0 ? void 0 : ch.postMessage(diags);
        };
        ...
        function reportDiagnostic(diagnostic) {
            ...
            const d = {
                ...
                file: (_a = diagnostic.file) === null || _a === void 0 ? void 0 : _a.fileName,
